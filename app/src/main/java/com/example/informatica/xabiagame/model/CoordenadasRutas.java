...
public class CoordenadasRutas {

    public static final String TABLE = "coordenadasrutas";
    ...
    public CoordenadasRutas(int id, String coordlatitud, String coordlongitud, String nombre, String descripcion){
        this.id = id;
