...
public class OneActionButtonDialog extends BlurDialogFragment {
    ...
    public OneActionButtonDialog() {
    }

    @NonNull
    @Override
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        return OneActionButtonDialog(savedInstanceState);
    }

    public Dialog OneActionButtonDialog(Bundle savedInstanceState) {
        ...
        builder.setTitle(getResources().getString(R.string.FalloAlGuardar))
                .setIcon(
                        getResources().getDrawable(
                                android.R.drawable.ic_dialog_info))
                .setMessage(getResources().getString(R.string.Fallo1))
